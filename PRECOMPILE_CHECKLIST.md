...
- [ ] **Help → User Guide** opens the guide. A "no longer where the tool
      expected it" alert means the `userguide` folder did not make it into the
      bundle, or `gui.userGuidePath` needs a `ctfroot` branch.
