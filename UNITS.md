...
deliberate mixed system, chosen because the CTE data the tool consumes is published
in 1/°C, and converting the CTE table would be a larger and more error-prone change
than converting temperature once at the GUI boundary.
