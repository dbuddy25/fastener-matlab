...
method = "NASA TM-106943 Eq. 72-74 (bolt bearing) — Eq. 73 area D*t, Eq. 72 Pbr = Fbr*Abr, Eq. 74 MS, both criteria, per TM p20 (these equations should be checked for both yield and ultimate conditions); required for the clamped parts by NASA-STD-5020B §4.4.1 p26 (ultimate) and §4.4.2 p29 (yield)";
