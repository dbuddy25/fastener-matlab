...
r = struct( ...
    ...
    "Inputs",  [ ...
        ...
        engine.eqInput("Ptu_allow", PtuAllow, "lbf", ...
            "the BOLT's own ultimate tensile allowable - NOT the 4.4.1 " + ...
            "system minimum the Tension-Ultimate row divides by"), ...
        engine.eqInput("Rt", Rt, "", ...
            "NASA-STD-5020B Eq. 20-23 - Rt = Ptu/Ptu_allow"), ...
        engine.eqInput("Psu", designLoads.Psu, "lbf", ...
            "engine.designLoads - Psu = FSU*FFU*PsL"), ...
        engine.eqInput("Psu_allow", shearUlt.ShearAllowable, "lbf", ...
            "engine.marginShearUlt - Eq. 12/13, Fsu*A_shear"), ...
        engine.eqInput("Rs", Rs, "", ...
            "NASA-STD-5020B Eq. 20-23 - Rs = Psu/Psu_allow"), ...
        engine.eqInput("Rb", Rb, "", ...
            "NASA-STD-5020B Eq. 20/22 bending ratio - Rb = fbu/Ftu; " + ...
            "exactly 0 when 4.4.4 exempts bending, which collapses the " + ...
            "criterion to the Rt^et + Rs^es form"), ...
        engine.eqInput("et", et, "", ...
            "tension exponent, by ShearPlane = " + string(joint.ShearPlane)), ...
        engine.eqInput("es", es, "", ...
            "shear exponent, by ShearPlane = " + string(joint.ShearPlane)), ...
        engine.eqInput("R", R, "", ...
            "NASA-STD-5020B Eq. 20-23 - R = Rs^es + (Rt + Rb)^et, PASS iff R <= 1")], ...
