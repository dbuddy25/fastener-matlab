...
r = struct( ...
    ...
    "Inputs",         [ ...
        engine.eqInput("Fsu", Fsu, "psi", ...
            "Joint.BoltMaterial.Fsu"), ...
        engine.eqInput("A_shear", area, "in^2", ...
            "Joint." + areaName + " - selected by ShearPlane = " + ...
            string(joint.ShearPlane)), ...
        engine.eqInput("Psu_allow", ShearAllowable, "lbf", ...
            "NASA-STD-5020B Eq. 12/13 - Psu_allow = Fsu*A_shear"), ...
        engine.eqInput("Psu", Psu, "lbf", ...
