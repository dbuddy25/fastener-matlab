classdef ProjectPage < gui.Page
    ...
    methods
        ...
        function refresh(obj)
            ...
            p = obj.State.Project;
            obj.AnalystField.Value     = char(gui.ProjectPage.fieldStr(p, 'analyst'));
            obj.ProgramField.Value     = char(gui.ProjectPage.fieldStr(p, 'program'));
            obj.AssemblyField.Value    = char(gui.ProjectPage.fieldStr(p, 'assembly'));
            obj.PartNumberField.Value  = char(gui.ProjectPage.fieldStr(p, 'partNumber'));
            obj.EnvironmentField.Value = char(gui.ProjectPage.fieldStr(p, 'environment'));
            obj.NotesArea.Value = cellstr(splitlines( ...
                gui.ProjectPage.fieldStr(p, 'notes')));
        end
    end
