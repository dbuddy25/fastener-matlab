classdef ReferencesView < handle
    ...
    %
    %   CREATE-OR-FOCUS, like gui.JointSectionView: opening Help >
    ...
    %   nothing tears it down automatically -- gui.FastenerApp.delete does
    ...
    methods (Access = private)
        function build(obj)
            ...
            obj.FolderLabel.FontColor = gui.palette('mutedText');
        end
        ...
        function onOpen(obj)
            ...
            gui.openExternal(f, obj.Fig);
        end

        function onChooseFolder(obj)
            start = gui.referencesFolder();
            ...
            gui.referencesFolder(string(chosen));
            obj.refresh();
        end
    end
