classdef TempLoadsPage < gui.Page
    ...
    %   currently open — hence the banner (GUI_SPEC.md Section 15,
    ...
    methods
        ...
        function build(obj, parent)
            ...
            obj.BannerLabel = obj.addBanner(g, 1, [1 2], ...
                ['GLOBAL — applies to every joint. This one Nominal/Hot/Cold ' ...
                 'trio is used for the single-joint analysis AND every joint ' ...
    ...
    methods (Access = private)
        function c = addTempField(obj, g, row, labelText, unitText, tip)
            ...
            un.Layout.Row    = row;
            un.Layout.Column = 3;
            un.FontColor     = gui.palette('mutedText');
            un.Tooltip       = tip;
        end
    ...
    %   tGuiSetupPages drives real matlab.uitest gestures (type) against
