    ...
    methods (Access = private)
        ...
        function buildAssumptionsGroup(obj, parent, row)
            ...
            obj.ShearTransferDropDown = obj.addDropdown(b, 6, ...
                ...
                ['Whether NASA-STD-5020B 4.4.4 bolt bending is accounted ' ...
                 'for. Default is OFF and unverified: fbu = 0 with the ' ...
                 'exemption recorded as ASSUMED. Verified means you have ' ...
                 'confirmed a close-tolerance or interference fit. ' ...
                 'Accounted for means shear crosses a gap or clearance - ' ...
                 'supply a bolt bending limit moment under Applied loads, ' ...
                 'or the interaction check reports not evaluated.']);
