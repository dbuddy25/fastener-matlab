classdef PreloadSpec
    ...
    %   inputs to the min/max preload equations (5020A Eq. 3/4/5, with the
    %   nominal preload from torque per 5020A Eq. 24).
    %
    %   Torque control is specified as NOMINAL torque + fractional tolerance
    %   (the 5020A c-factor form): a spec of "470 ± 20 in-lb" is
    %   NominalTorque = 470, TorqueTolerance = 20/470, giving the c-factors
    %   c_max = 1 + tol and c_min = 1 - tol of 5020A Eq. 3/4/5 (e.g. 5020A
    ...
    properties
        ...
        SeparationCritical (1,1) logical = false                         % selects min-preload eqn (5020A Eq. 4 vs Eq. 5)
    ...
    properties (Dependent)
        ...
        CMax               % 5020A c_max = 1 + TorqueTolerance (Eq. 3)
        CMin               % 5020A c_min = 1 - TorqueTolerance (Eq. 4/5)
    end
