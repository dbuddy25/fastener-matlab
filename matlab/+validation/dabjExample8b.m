...
% (kc's coefficient taken as the exact pi*tan(30 deg) = 1.81380, not the
% book's own 3-sig-fig 1.81) gives Kb 2.3892e6, Kc 4.7352e6, Phi 0.3354 —
% Kc lands ~0.21% above the book's 4.73e6 (rounds to 4.74e6, not 4.73e6,
% because the book's own printed constant is itself the rounded one); the
% RelTol below still passes it.
