classdef tGuiHardwareLibrary < matlab.uitest.TestCase
    ...
    methods (Test)
        function theRailPageIsNoLongerAPlaceholder(testCase)
            testCase.verifyClass(testCase.Page, "gui.HardwareLibraryPage");
    ...
    methods (Test)
        ...
        function aCustomEntryAppearsAndIsLabelled(testCase)
            ...
            lib = lib.addMaterial(struct( ...
                ...
                "fsu", 60000, "source", "tGuiHardwareLibrary test entry"));
        ...
        function aDropInAppearsUnderItsOwnFilterAndASkippedOneIsReported(testCase)
            ...
            good = struct("key", "Dropped alloy", "ftu", 100000, "fty", 90000, ...
                "fsu", 60000, "source", "tGuiHardwareLibrary drop-in");
        ...
        function aLibraryChangeRefreshesThePageWithoutRenavigating(testCase)
            ...
            lib = lib.addMaterial(struct( ...
                ...
                "source", "tGuiHardwareLibrary test entry"));
