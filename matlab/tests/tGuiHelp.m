classdef tGuiHelp < matlab.uitest.TestCase
    ...
    %
    %   NOTHING HERE OPENS A DOCUMENT. gui.openExternal hands a file to
    ...
    methods (Test)
        ...
        function helpIsOnTheMenuBarAndNotTheRail(testCase)
            % GUI_SPEC decided User Guide and References are NOT pages.
            % tGuiShell pins the rail; this pins the other half of that
