classdef tLibrary < matlab.unittest.TestCase
    ...
    methods (Test)
        ...
        function seededCatalogExposesAllShcsSizes(testCase)
            ...
            lib = data.Library.load();
            keys = lib.boltKeys();
            testCase.verifyGreaterThanOrEqual(numel(keys), 32);
            testCase.verifyEqual(keys(1), "NAS1351 #0-80");
            expected = [ ...
                "NAS1351 #0-80"  "NAS1352 #1-64"  "NAS1352 #2-56"  "NAS1351 #2-64" ...
                "NAS1352 #3-48"  "NAS1351 #3-56"  "NAS1352 #4-40"  "NAS1351 #4-48" ...
                "NAS1352 #5-40"  "NAS1351 #5-44"  "NAS1352 #6-32"  "NAS1351 #6-40" ...
                ...
                "NAS1352 1/2-13" "NAS1351 1/2-20" "NAS1352 9/16-12" "NAS1351 9/16-18" ...
