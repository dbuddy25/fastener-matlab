...
s.LoadCase = model.LoadCase(Name = "Liftoff", ...
...
el.Cases(1) = gui.AppState.elementCase("Liftoff");
el.Cases(2) = gui.AppState.elementCase("Landing", 1.5);
el.Rows(end + 1) = gui.AppState.elementRow("1001", "Liftoff", ...
    forces(FX = 1560, FZ = 5590));
el.Rows(end + 1) = gui.AppState.elementRow("1002", "Liftoff", ...
    forces(FX = -150, FY = 200, FZ = -800, MX = 10, MY = 5));
el.Rows(end + 1) = gui.AppState.elementRow("1003", "Landing", ...
